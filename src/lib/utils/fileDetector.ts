...
export class FileDetector {
  ...
  // These defaults ensure consistent timeout behavior across all file-detection logic.
  private static readonly DEFAULT_NETWORK_TIMEOUT = 30000; // 30 seconds
  private static readonly DEFAULT_HEAD_TIMEOUT = 5000; // 5 seconds
