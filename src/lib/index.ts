 ...
 *
 * Comprehensive text-to-speech functionality with Google Gemini integration
 * and cross-platform audio playback support.
 *
 * @example
 * ```typescript
 ...
 *
 * // Create TTS service
 * const tts = createTTSService(process.env.GEMINI_API_KEY);
 *
