...
import { parseTimeout, TimeoutError, getDefaultTimeout } from '../lib/utils/timeout.js';
import { createTimeoutController, withTimeout, withStreamingTimeout } from '../lib/providers/timeout-wrapper.js';
...
describe('Timeout Utilities', () => {
  ...
  describe('TimeoutError', () => {
    it('should create proper error instances', () => {
      const error = new TimeoutError('Test timeout', 5000, 'openai', 'generate');
...
describe('Timeout Controller', () => {
  describe('createTimeoutController', () => {
    ...
    it('should return null for undefined timeout', () => {
      const controller = createTimeoutController(undefined, 'openai', 'generate');
  ...
  describe('withTimeout', () => {
    ...
    it('should reject with TimeoutError on timeout', async () => {
      ...
      await expect(withTimeout(promise, 100, 'openai', 'generate'))
    ...
    it('should preserve original promise rejection', async () => {
      ...
      await expect(withTimeout(promise, 1000, 'openai', 'generate'))
      ...
      OpenAI: class {
        async generateText(options: any) {
          ...
          if (timeoutMs && timeoutMs < 100) {
            throw new TimeoutError('Operation timed out', 100, 'openai', 'generate');
          }
