...
/**
 * Optimized utility function to recursively find files by extension
 * Enhanced for better performance with early exit conditions and file system optimization
 */
function findFilesByExtension(
  ...
  function traverse(currentDir, depth = 0) {
    ...
    // Prevent processing same directory twice (symlink protection)
    ...
    try {
      ...
      if (
        process.env.DEBUG_ADAPTIVE_RUNNER ||
