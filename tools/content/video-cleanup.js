#!/usr/bin/env node
/**
 * Video Cleanup Tool - JavaScript Conversion Example
 *
 * Converts the cleanup-hash-named-videos.sh shell script to modern JavaScript.
...
class VideoCleanup {
	...
	isSuspicious(fileName, fileInfo) {
	...
	async backupAndRemove(fileInfo) {
