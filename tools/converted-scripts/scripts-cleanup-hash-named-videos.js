 ...
 */
async function cleanup_hash_files(files_to_delete, dry_run = false) {
	if (dry_run) {
...
async function run() {
	...
	if (args.includes("--help") || args.includes("-h")) {
		console.log(
			"Usage: node tools/converted-scripts/scripts-cleanup-hash-named-videos.js [--dry-run] [--force] [--help]",
		);
		console.log(
