...
export { ScriptAnalyzer } from './script-analyzer.js';
export { EnvironmentManager } from './environment-manager.js';
export { ProjectOrganizer } from './project-organizer.js';

// Additional automation tools (implement as needed)
// export { BuildSystem } from './build-system.js';
...
- **script-analyzer.js** - Analyzes and cleans up duplicate scripts
- **environment-manager.js** - Safe .env file management with backup
- **project-organizer.js** - Intelligent project structure organization
...
// export { AdaptiveTestRunner } from './adaptive-test-runner.js';
