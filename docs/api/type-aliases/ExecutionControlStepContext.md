...
Defined in: [types/stream.ts:239](https://github.com/juspay/neurolink/blob/release/src/lib/types/stream.ts#L239)
...
Defined in: [types/stream.ts:241](https://github.com/juspay/neurolink/blob/release/src/lib/types/stream.ts#L241)
