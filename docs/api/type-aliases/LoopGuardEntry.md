...
Defined in: [types/context.ts:849](https://github.com/juspay/neurolink/blob/release/src/lib/types/context.ts#L849)
...
Defined in: [types/context.ts:853](https://github.com/juspay/neurolink/blob/release/src/lib/types/context.ts#L853)
