...
| Feature                                                                             | Description                                                                                        |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| :material-microphone: **[Audio File Support](audio-support.md)**                    | Transcribe audio files (MP3, WAV, FLAC, M4A) with multi-language support for meetings and voice notes. |
...
| **Multimodal pipeline**  | Stream images + audio + CSV data + PDF documents across providers with local/remote assets. Auto-detection for mixed file types. | [Multimodal Guide](multimodal-chat.md), [Audio Support](audio-support.md), [CSV Support](csv-support.md), [PDF Support](pdf-support.md) |
