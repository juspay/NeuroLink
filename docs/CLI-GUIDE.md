...
# Multimodal streaming - Image analysis
npx @juspay/neurolink stream "Describe this image in detail" --image photo.jpg

# Multimodal streaming - PDF walkthrough
npx @juspay/neurolink stream "Explain this document step by step" --pdf report.pdf

# Multimodal streaming - CSV data analysis
npx @juspay/neurolink stream "Analyze the trends in this data" --csv sales.csv
```
