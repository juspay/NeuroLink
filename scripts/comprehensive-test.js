...
class ComprehensiveTester {
  ...
  async testCoreFeatures() {
    ...
    const testFiles = [
      ...
      "src/test/health-monitoring.test.ts",
  ...
  async testDemoScripts() {
    ...
    const demoScripts = [
      ...
      "scripts/examples/error-handling-demo.js",
      "scripts/examples/health-monitoring-demo.js",
  ...
  async testProviderIntegration() {
    ...
    // Test model server
    const modelServerProcess = spawn("pnpm", ["run", "model-server"], {
      stdio: "pipe",
      detached: false
    });
  ...
  generateSummaryReport() {
    ...
    const reportPath = this.saveResults("comprehensive-test-report.json", summary);
